...
import type { WonGameResult } from "./dealNoMercyPageTypes";

type DealNoMercyGameEndOverlayProps = {
...
const DealNoMercyGameEndOverlay = ({
  wonGame,
  winnerName,
  winnerAvatarUrl,
  winnerInitial,
  onGoHome,
}: DealNoMercyGameEndOverlayProps) => {
  return (
    <section
...
export default DealNoMercyGameEndOverlay;
