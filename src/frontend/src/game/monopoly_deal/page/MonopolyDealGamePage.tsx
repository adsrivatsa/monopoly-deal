...
import MonopolyDealGameEndOverlay from "./MonopolyDealGameEndOverlay";
import MonopolyDealGameSidebar from "./MonopolyDealGameSidebar";
import type {
  ActionHistoryEntry,
  GameChatMessage,
  WonGameResult,
...
export default MonopolyDealGamePage;
